        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: 'Settings', emoji: '⚙️', title: 'Собственное производство под ваш размер', desc: 'Не стандартные размеры из каталога, а точные. Режем и шьём под каждое окно отдельно.' },
              ...
              { icon: 'ShieldCheck', emoji: '🛡', title: 'Гарантия 1 год', desc: 'Если механизм выйдет из строя — заменим бесплатно. Не звонок в колл-центр, а приезд мастера.' },
            ].map((item) => (
              <div
                key={item.title}
